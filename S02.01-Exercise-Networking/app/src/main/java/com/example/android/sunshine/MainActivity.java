...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData() {
        ...
        new PerformNetworkRequestTask().execute(url);
    }

    // TODO (5) Create a class that extends AsyncTask to perform network requests
    // TODO (6) Override the doInBackground method to perform your network requests
    // TODO (7) Override the onPostExecute method to display the results of the network request
    public class PerformNetworkRequestTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try {
                ...
                String[] simpleWeatherStrings = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, responseFromHttpUrl);
